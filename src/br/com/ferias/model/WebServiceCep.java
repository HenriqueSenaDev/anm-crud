...
/**
 * Ferramenta de busca de CEP, veja o m�todo
 * {@link WebServiceCep#searchCep(String)} para maiores informa��es.
 * <BR>
 * <BR>Constroi um objeto {@link WebServiceCep} com os dados XML encapsulados, a
 * partir da chamada do m�todo estatico {@link WebServiceCep#searchCep(String)}.
 * <BR>
 * <BR>Objeto contem todas as informa��es do XML, al�m de informa��es referente
 * ao resultado da pesquisa.
 * <BR>
 * <BR>Esta ferramente depende diretamente do pacote <tt>org.dom4j</tt> para
 * fazer o parse dos arquivos XML. O pacote dom4j.jar pode ser encontrado em
 * <a href="http://www.dom4j.org/dom4j-1.6.1/download.html" target="_blank">dom4j.org</a>
 * <BR>
 * <BR>Exemplo de uso:
 * <BR><tt>{@link WebServiceCep} cep =
 * {@link WebServiceCep}.searchCep("13345-325");
 *
...
public final class WebServiceCep {
     ...
     * m�todo correspondente, invocando a partir de um atalho comum
